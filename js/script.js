	...
	else
	{
		...
		if(intRegex.test(e))
		{
			...
			if (result.length != 0)
           	{
            	if (result.length === 1)
            		$("#aggiunta").html('<input id="comune" name="comune" type="text" value="'+result[0]+'" readonly style="color:#fff"/>').show("fast");
            	else
            	{
            		var city_select = "";
            		for(var i = 0; i < result.length; i++)
            			city_select += "<option value='"+result[i]+"'>"+result[i]+"</option>";
...
function vai_b(){
	...
	$(".bottom").css("padding", "2px 31px 31px 31px");
	$("div#form .box3").css({"font-family":"Roboto","color":"rgba(255, 255, 255, 1)","font-weight":"600","text-shadow":"0px 1px 5px #000"});
	$(".top").css("background-image", "url('http://46.255.163.33/partez_avec_leglobetrotteur/concorso_turista_curioso/3c3e4b.png");
	$(".top").html('<div id="cdcr_baseblock_42221_14" class="cdcr_baseblock1" style="overflow:hidden;min-height:65px;"><div class="cdcr_logo cdcr_logoleft" style="float:left;"><img src="./Ofelix_files/obseques.png"></div><div class="cdcr_campaign_description" style="overflow:hidden; text-align:left;"><b class="title">Pour protéger vos proches, organisez et financez vos obsèques dès aujourd\'hui !</b><div class="cdcr_campaign_terms" style="text-align:left;"><div class="cdcr_campaign_terms_text" style="overflow:hidden;"><span style="font-size:12px"> <a style="font-size:12px">Souhaitez-vous être contacté par téléphone par un professionnel de l\'assurance santé pour une estimation gratuite et sans engagement de votre part ?</a></span></div><br><div style="overflow:hidden;float:left" class="cdcr_campaign_terms_input"><div class="cdcr_form_radio_option" style="overflow:hidden;"><a style="font-size:12px"><label>Oui</label><input type="radio" name="infocomercial-42221" id="infocomercialsi-42221" value="si" onclick="__cdcr_campaign_accept_42221();"></a></div><a style="font-size:12px"><div class="cdcr_form_radio_option" style="overflow:hidden;"><label>Non</label><input type="radio" name="infocomercial-42221" id="infocomercialno-42221" value="no" onclick="__cdcr_campaign_reject_42221();"></div></a></div><a style="font-size:12px"></a></div><a style="font-size:12px"></a></div><a style="font-size:12px"></a></div></div>');
	$(".top").append('<div id="cdcr_baseblock_46565_6" class="cdcr_baseblock1" style="overflow:hidden;min-height:65px;"><div class="cdcr_logo cdcr_logoleft" style="float:left;"><img src="./Ofelix_files/logo-dah-120x60.jpg"></div><div class="cdcr_campaign_description" style="overflow:hidden; text-align:left;"><b class="title">Défense Assurances Hospitalisation, 2 mois offerts pour soulager mon budget santé !</b><div class="cdcr_campaign_terms" style="text-align:left;"><div class="cdcr_campaign_terms_text" style="overflow:hidden;"><span style="font-size:12px;text-decoration:none !important;">Accident, maladie ou maternité, avec  Défense Assurances Hospitalisation, profitez d’une indemnité de 150€/jour d’hôpital et d’une assistance personnalisée. Contactez moi pour un devis sans engagement et 2 mois d’assurances offerts.</span></div><br><div style="overflow:hidden;float:left" class="cdcr_campaign_terms_input"><div class="cdcr_form_radio_option" style="overflow:hidden;"><label>Oui</label><input type="radio" name="infocomercial-46565" id="infocomercialsi-46565" value="si" onclick="__cdcr_campaign_accept_46565();"></div><div class="cdcr_form_radio_option" style="overflow:hidden;"><label>Non</label><input type="radio" name="infocomercial-46565" id="infocomercialno-46565" value="no" onclick="__cdcr_campaign_reject_46565();"></div></div></div></div></div>');
}
